import { PrintCardMemory } from "../components/CardMemory/CardMemory";
...
export const generateRandom = (size = 4) => {
  ...
  for (let i = 0; i < size; i++) {
    ...
    // con el splice quitas el imagen que ya has metido en cardValue y lo quitar de tempArray
        ...
        if (!getStateMemory("firstCard")) {
          ...
          if (
            ...
            if (
              ...
              result.innerHTML = `<div class="HAS GANADO!"><img class src="./sourceMemory/YouWon.gif" />
            `;
...
const movesCounter = () => {
  ...
  moves.innerHTML = `<span>Movimientos:</span>${getStateMemory("movesCount")}`;
};
